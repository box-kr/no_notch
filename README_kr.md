...
- **다이얼로그 윈도우(Dialog Window) 인터페이스 개선**:
  ...
  - 창 전환(Cmd + Tab) 시에도 다이얼로그 창으로 원활히 포커스를 옮길 수 있도록 앱 비활성화 숨김 속성(`hidesOnDeactivate = false`)을 조정했습니다.
  - 앱 창이 '미션 컨트롤(Mission Control / Exposé)' 화면에서도 정상적으로 표시되도록 윈도우 속성을 개선하여 창 접근성을 대폭 향상했습니다.
